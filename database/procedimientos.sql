...
BEGIN
    ...
    IF usuario_estado = 'INACTIVO' THEN
        ...
        SET salida = "SE ACTIVO LA SUSCRIPCION CORRECTAMENTE";
    ELSE
        SET salida = "EL USUARIO YA CUENTA CON UNA SUSCRIPCION ACTIVA";
    END IF;
END$$
DELIMITER ;
...
BEGIN
    ...
    ELSE
        SET salida = "EL USUARIO NO TIENE UNA SUSCRIPCION ACTIVA ACTUALMENTE"; 
    END IF;
END$$
DELIMITER ;
