...
ALTER TABLE FAVORITO ADD CONSTRAINT FAVORITO_USUARIO_FK FOREIGN KEY (USUARIO_USU_ID) REFERENCES USUARIO (USU_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE FAVORITO ADD CONSTRAINT FAVORITO_VIDEO_FK FOREIGN KEY (VIDEO_VID_ID) REFERENCES VIDEO (VID_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE SUSCRIPCION ADD CONSTRAINT SUSCRIPCION_USUARIO_FK FOREIGN KEY (USUARIO_USU_ID) REFERENCES USUARIO (USU_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE VIDEO ADD CONSTRAINT VIDEO_CLASIFICACION_FK FOREIGN KEY (CLASIFICACION_CLA_ID) REFERENCES CLASIFICACION (CLA_ID) ON DELETE NO ACTION ON UPDATE NO ACTION;
